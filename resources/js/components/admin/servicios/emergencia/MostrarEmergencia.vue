  ...
  <div class="col-10 m-0 m-auto">
    <div class="card">
      <div class="card-header pt-0">
        <h2 class="pt-4 m-0">Gestión de Servicios Abogado de Emergencia</h2>
      </div>
      <div class="card-body">
        <div class="form-row d-flex align-items-center">
          ...
          <div class="form-group col-md-6">
            <router-link
              to="/admin/create/servicio/emergencia"
              href="#"
          ...
          <table class="table table-striped table-md">
            <tbody>
              ...
              <tr v-for="ser in Servicio.data" :key="ser.id">
                ...
                <td class="center">
                  <router-link
                    :to="`/admin/edit/servicio/emergencia/${ser.id}`"
...
export default {
  ...
  methods: {
    getServicio(page = this.numero) {
      axios
        .get("/api/show/servicio/emergencia?page=" + page, {
