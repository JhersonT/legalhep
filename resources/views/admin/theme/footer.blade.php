...
{{-- 	<script src="{{asset("js/app.js")}}"></script> --}}
	<!-- JS Libraies -->
	<script src="{{asset("admin/bundles/chartjs/chart.min.js")}}"></script>
	...
	<script src="{{asset("admin/bundles/jqvmap/dist/maps/jquery.vmap.world.js")}}"></script>
	<script src="{{asset("admin/bundles/jqvmap/dist/maps/jquery.vmap.indonesia.js")}}"></script>
  ...
  <script src="{{asset("admin/bundles/ckeditor/ckeditor.js")}}"></script>
	...
	<script src="{{asset("admin/js/page/index2.js")}}"></script>
...
<script src="{{asset("admin/bundles/fullcalendar/fullcalendar.min.js")}}"></script>
<!-- Page Specific JS File -->
<script src="{{asset("admin/js/page/calendar.js")}}"></script>
