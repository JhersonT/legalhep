    ...
    @include('miabogado.menu')
        ...
        <div class="contenido-confirmar-pago">
            ...
            <div class="detalle-pago">
                <h3>Tipo Consulta: {{$consult->modalidad}}</h3>
                <h5>Costo del servicio: <span> S/ {{$consult->precio}}</span>
                <h5>Código de solicitud : <span> {{$consult->numeroConsulta}}</span>
                </h5>
            </div>
            <div>
            ...
            <div class="contenido-botones-pago">
                @forelse ( $link as $li )
                <a href="{{$li->link}}" class="btn-pago">Iniciar Consulta</a>
                @empty
