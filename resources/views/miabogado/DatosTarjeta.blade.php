...
<body>
    ...
    <div class="principal">
        <div class="principal-logo">
            ...
            <div class="borde">
                <p class="sub-titulo"><a href="{{route("consulta.abogado")}}" class="links">Tipo Consulta </a> > <a href="{{route("tipo.pago",['consulta'=>$consult->numeroConsulta])}}" class="links">Tipo de Pago </a> > <a href="#" class="links">Tarjeta</a> </p>
            </div>
        </div>
        <div class="body-miabogado">
            <h4 class="titulo-tipo-consulta">Consulta tipo {{ $consult->modalidad }}</h4>
