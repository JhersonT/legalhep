...
<body>
    ...
    <div class="principal">
        <div class="principal-logo">
            ...
            <div class="borde">
                <p class="sub-titulo"><a href="{{route("consulta.abogado")}}" class="links">Tipo Consulta </a> > <a href="{{route("tipo.pago",['consulta'=>$consult->numeroConsulta])}}" class="links">Tipo de Pago </a> > <a href="#" class="links">Depósito Bancario</a></p>
            </div>
        ...
        <div class="body-miabogado">
            ...
            <form action="{{route("save.voucher")}}" method="POST" enctype="multipart/form-data">
                @csrf
