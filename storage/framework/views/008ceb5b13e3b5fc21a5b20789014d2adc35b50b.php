...
<body>
    <div class="contenido-email">
        ...
        <div class="contenido-bienvenida">
                ...
                <p>Estimado: <?php echo e($user->name); ?></p>
                <p>Hemos recibido tu solicitud de recuperación de contraseña LEGALHELP:</p>
                <p>Tu nueva contraseña es: <?php echo e($contraseña); ?> . Por precaución conserva tu contraseña en un lugar seguro.</p>
                ...
                <a href="<?php echo e($url); ?>">Cambiar Contraseña</a>
...
</html><?php /**PATH C:\Users\jhers\Desktop\fabriqa\repositorios\legalHelp\resources\views/email/reset-password.blade.php ENDPATH**/ ?>