...
<body>
    <div class="contenido-email">
        ...
        <div class="contenido-bienvenida">
                ...
                <ul>
                    <li>Tipo de documento: <?php echo e($user->client->tipo_doc); ?></li>
                    <li>Número Documento: <?php echo e($user->client->n_doc); ?></li>
                    <li>Departamento: <?php echo e($user->client->departamento); ?></li>
                    <li>Nombres:  <?php echo e($user->client->nombres); ?></li>
                    <li>Apellidos:  <?php echo e($user->client->apellidos); ?></li>
                    <li>Contraseña: <?php echo e($user->client->pass); ?></li>
                </ul>
                <p>Para confirmar su registro debe darle click en el siguiente link</p>
                <a href="<?php echo e($url); ?>">Confirmar Registro</a>
...
</html><?php /**PATH C:\Users\jhers\Desktop\fabriqa\repositorios\legalHelp\resources\views/email/email.blade.php ENDPATH**/ ?>