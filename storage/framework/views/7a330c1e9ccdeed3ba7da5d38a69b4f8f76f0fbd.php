...
<body>
    ...
    <div class="principal">
        <div class="principal-logo">
            ...
            <tipo-emergencia :id="<?php echo e(auth()->user()->id); ?>" :codigo="<?php echo e($consulta); ?>" />
    </div>
</div>
...
<?php /**PATH C:\Users\jhers\Desktop\fabriqa\repositorios\legalHelp\resources\views/abogado-emergencia/tipoPago.blade.php ENDPATH**/ ?>