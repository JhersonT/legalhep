...
<body>
    ...
    <?php
        ...
        $preference->back_urls = [
            'success' => 'http://127.0.0.1:8000/confirmacion/pago/'.$consult->numeroConsulta."?consulta=".$consult->numeroConsulta,
            'failure' => 'http://127.0.0.1:8000/pago/error/'.$consult->numeroConsulta."?consulta=".$consult->numeroConsulta,
    ...
    <div class="principal">
        <div class="principal-logo">
            ...
            <div class="borde">
                <p class="sub-titulo"><a href="<?php echo e(route("consulta.abogado")); ?>" class="links">Tipo Consulta </a> > <a href="<?php echo e(route("tipo.pago",['consulta'=>$consult->numeroConsulta])); ?>" class="links">Tipo de Pago </a> > <a href="#" class="links">Tarjeta</a> </p>
            </div>
        </div>
        <div class="body-miabogado">
            <h4 class="titulo-tipo-consulta">Consulta tipo <?php echo e($consult->modalidad); ?></h4>

            <div class="contenido-monto-pago">
...
<?php /**PATH C:\Users\jhers\Desktop\fabriqa\repositorios\legalHelp\resources\views/miabogado/DatosTarjeta.blade.php ENDPATH**/ ?>