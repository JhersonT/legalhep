...
<body>
    ...
    <div class="principal">
        <div class="principal-logo">
            ...
            <div class="borde">
                <p class="sub-titulo"><a href="<?php echo e(route("consulta.abogado")); ?>" class="links">Tipo Consulta </a> > <a href="<?php echo e(route("tipo.pago",['consulta'=>$consult->numeroConsulta])); ?>" class="links">Tipo de Pago </a> > <a href="#" class="links">Depósito Bancario</a></p>
            </div>
        ...
        <div class="body-miabogado">
            ...
            <form action="<?php echo e(route("save.voucher")); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\Users\jhers\Desktop\fabriqa\repositorios\legalHelp\resources\views/miabogado/EnvioVoucher.blade.php ENDPATH**/ ?>